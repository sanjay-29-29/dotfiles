...
run_once({ "urxvtd", "unclutter -root", "nm-applet" }) -- comma-separated entries
...
beautiful.init("/home/pc/.config/awesome/zenburn/theme.lua")
...
local batterywidgettimer = gears.timer({ timeout = 10 })
...
local function update_cpu()
	awful.spawn.easy_async_with_shell(
		...
		function(output)
			cpuwidget:set_text(" | CPU: " .. output:gsub("\n", "") .. "%")
		end
	)
end
...
globalkeys = gears.table.join(
	...
	awful.key({ modkey }, "q", function()
		awful.spawn.with_shell("/usr/bin/chromium")
	end, { description = "launch a instance of chromium" }),
	awful.key({}, "XF86MonBrightnessUp", function()
		awful.spawn("light -A 5") -- Increase brightness by 5%
	end, { description = "increase brightness", group = "system" }),
	awful.key({}, "XF86MonBrightnessDown", function()
		awful.spawn("light -U 5") -- Decrease brightness by 5%
	end, { description = "decrease brightness", group = "system" }),
	awful.key({}, "XF86AudioRaiseVolume", function()
		awful.spawn("amixer set Master 5%+") -- Increase volume by 5%
	end, { description = "increase volume", group = "system" }),
	awful.key({}, "XF86AudioLowerVolume", function()
		awful.spawn("amixer set Master 5%-") -- Decrease volume by 5%
	end, { description = "decrease volume", group = "system" }),
	awful.key({}, "XF86AudioMute", function()
		awful.spawn("amixer set Master toggle") -- Mute/Unmute audio
	end, { description = "mute/unmute volume", group = "system" })
)
